...
// Auto-contenida, sin props — maneja su propio loop internamente. Así
// tiene que ser cualquier otra animación que se agregue a la biblioteca
// (ver ./index.ts).
export default function WaveTravelerAnimation() {
